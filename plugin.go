...
import (
	...
	"github.com/slipros/gid-data-golang-eval/analyzers/convplace"
	...
	"github.com/slipros/gid-data-golang-eval/analyzers/ifaceassert"
...
func init() {
	...
	register.Plugin("gidconvplace", newSingleAnalyzerPlugin(convplace.Analyzer, register.LoadModeTypesInfo))
	...
	register.Plugin("gidmodeltags", newConfigurablePlugin(dbtags.NewModelAnalyzer, register.LoadModeTypesInfo))
	register.Plugin("giderrfile", newConfigurablePlugin(errplace.NewFileAnalyzer, register.LoadModeTypesInfo))
	register.Plugin("gidfilterplace", newSingleAnalyzerPlugin(filterplace.Analyzer, register.LoadModeTypesInfo))
	register.Plugin("gidifacenaming", newConfigurablePlugin(ifacenaming.NewAnalyzer, register.LoadModeTypesInfo))
	...
	register.Plugin("gidclientwiring", newSingleAnalyzerPlugin(clientwiring.Analyzer, register.LoadModeTypesInfo))
	register.Plugin("gidifaceplace", newConfigurablePlugin(ifaceplace.NewAnalyzer, register.LoadModeTypesInfo))
	...
	register.Plugin("gidutilpkg", newConfigurablePlugin(utilpkg.NewAnalyzer, register.LoadModeTypesInfo))
	...
	register.Plugin("gidpkgstutter", newSingleAnalyzerPlugin(pkgstutter.Analyzer, register.LoadModeTypesInfo))
