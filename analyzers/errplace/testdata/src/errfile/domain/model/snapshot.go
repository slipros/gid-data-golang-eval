...
var ErrSnapshotConflict = errors.New("snapshot conflict") // want `GID-169: ошибка "ErrSnapshotConflict" объявлена в snapshot\.go — ошибки слоя живут в error\.go`
...
var errValidation = &ValidationError{} // want `GID-169: ошибка "errValidation" объявлена в snapshot\.go — ошибки слоя живут в error\.go`
